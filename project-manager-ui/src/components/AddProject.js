...
export default class AddProject extends React.Component {
 ...
 /*  onChange(fieldName,value){
  ...
  updateProject(){
    ...
    const addProject=this.props.addProjectForm;
...
newProjectList.unshift(response.project);
...
// }
  ...
  render() {
      ...
      const formData=this.props.addProjectForm;
    ...
    <Container style={containerStyle}>
      <Form >
        <FormGroup row>
         ...
         <Col sm={6}> 
            <Input type="text" name="projectName" id="projectName" placeholder="" value={formData.projectName} onChange={e => this.props.onChange("projectName",e.target.value)}/>
          </Col> 
        </FormGroup>
        <FormGroup row>
          <Col sm={3}>
        {/* <Label check> */}
            <br/>
            <Input type="checkbox" name="check" id="check" checked={formData.isSetStartDateEndDate} onChange={e=>this.props.onChange("check",e.target.checked)}/>
        ...
        <Label for="projectStartDateLabel">Start Date</Label>
            <Input type="date" name="projectStartDate" id="projectStartDate" placeholder="Start Date" 
             ...
             //value={formData.projectStartDate==""?strDt:formData.startDate}
              //value={strDt}
             onChange={e => this.props.onChange("projectStartDate",e.target.value)}
          ...
          <Label for="projectEndDateLabel">End Date</Label>
            <Input type="date" name="projectEndDate" id="projectEndDate" placeholder="End Date" disabled={formData.isSetStartDateEndDate?false:true} value={formData.projectEndDate} onChange={e => this.props.onChange("projectEndDate",e.target.value)} />
          </Col>
        </FormGroup>
        <FormGroup row>
           ...
           {/* <Col md={10}>
            ...
            {<Col sm={6}>
             <Range allowCross={false} min={0} max={30} name="projectPriority" value={formData.projectPrioritySlider} onChange={e => this.props.onChange("projectPriority",e)} />
            </Col>}
        </FormGroup>
        <FormGroup row>
          <Label for="projectManagerLabel" sm={3}>Manager :</Label>
          <Col sm={5}>
            <Input type="text" name="projectManagerName" id="projectManagerName" placeholder="" readOnly={true} value={formData.projectManagerName} onChange={e => this.props.onChange("projectManagerName",e.target.value)}/>
          </Col>
          <Col sm={2}>
      ...
      <div>
        ...
        <Button  color="secondary" hidden={this.props.projectAction ==="edit"?false:true}onClick={()=>this.updateProject()}>Update</Button>{' '}
        ...
        < ProjectGrid ref="childProjectGrid" 
